    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            if(args.classifier == 'SVM'):
                ...
                model = RandomForestClassifier(n_estimators=2000, max_depth=100, max_features='sqrt', n_jobs=-1)   
...
def parse_args():
    ...
    parser.add_argument('--classifier', type=str, choices=['KNN','SVM','RF','LinearSVC'],
